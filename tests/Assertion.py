...
class AssertionTest(unittest.TestCase):
    ...
    def test_begin_before_than_begin(self):

        # -------------------------------------------------------

        league_of_legends: SimpleTime = SimpleTime(
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.begin_before_than_begin(
        ...
        valorant: SimpleTime = SimpleTime(
            begin = self.begin_2, duration=self.duration_1
        )
    ...
    def test_begin_after_than_begin(self):
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.begin_after_than_begin(
                league_of_legends, valorant),
            second=False,
    ...
    def test_finish_before_than_begin(self):
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.finish_before_than_begin(
                league_of_legends, valorant),
            second=False,
    ...
    def test_finish_after_than_begin(self):
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.finish_after_than_begin(
                league_of_legends, valorant),
            second=False,
    ...
    def test_begin_before_than_finish(self):
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.begin_before_than_finish(
                league_of_legends, valorant),
            second=False,
    ...
    def test_begin_after_than_finish(self):
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.begin_after_than_finish(
                league_of_legends, valorant),
            second=False,
    ...
    def test_finish_before_than_finish(self):
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.finish_before_than_finish(
                league_of_legends, valorant),
            second=False,
            msg = 'League of legend shoud not begin after than Valorant finish'
        )
        ...
        valorant: SimpleTime = SimpleTime(
            begin = self.begin_1, duration=self.duration_2
        )
    ...
    def test_finish_after_than_finish(self):
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.finish_after_than_finish(
                league_of_legends, valorant),
            second=False,
    ...
    def test_begin_before_datetime(self):
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.begin_before_datetime(
                valorant, before),
            second=False,
    ...
    def test_begin_after_datetime(self):
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.begin_after_datetime(
                valorant, after),
            second=False,
    ...
    def test_finish_before_datetime(self):
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.finish_before_datetime(
                valorant, before),
            second=False,
    ...
    def test_finish_after_datetime(self):
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.finish_after_datetime(
                valorant, after),
            second=False,
    ...
    def test_between_datetime(self):
        ...
        self.assertEqual(
            first=TimeToolBox.Assertion.between_datetime(
