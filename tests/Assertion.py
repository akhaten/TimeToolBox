...
class AssertionTest(unittest.TestCase):
    ...
    def test_begin_before_begin(self):
    ...
    def test_begin_after_begin(self):
    ...
    def test_finish_after_begin(self):
    ...
    def test_begin_before_finish(self):
    ...
    def test_finish_before_finish(self):
